...
/*
	    ...
	    $(window).scroll(function() {
            ...
            if (s <= 7300 + offset + offset2) {
                ...
                if (s > 7900 + offset + offset2) {
                    ...
                    addTweensHeight(['.box6 .corclecontainerbtm'], "75px", 0.2);
                    ...
                    addTweensHeight(['.box5 .corclecontainerbtm'], "50px", 0.2);
                }
                    ...
                    addTweensHeight(['.box4 .corclecontainerbtm'], "50px", 0.2);
	                ...
	                addTweensHeight(['.box3 .corclecontainerbtm'], "120px", 0.2);
	                ...
	                addTweensHeight(['.box1 .corclecontainerbtm'], "50px", 0.2);
                    ...
                    addTweensHeight(['.box1 .border-animation'], "320px", 0.2);
                    addTweensHeight(['.box1 .corclecontainerbtm'], "0px", 0.2);
                }
	            else if (s > 3400 + offset) {
                    addTweensHeight(['.box1 .border-animation'], "200px", 0.2);
                    addTweens(['.box1 .txtrightwithoutbg span'], 1);
                }
	            else if (s > 3300 + offset) {
                    addTweensWidth(['.box2 .border-animation'], "390px", 0.2);
                    addTweensWidth(['.box3 .border-animation'], "390px", 0.2);
                    addTweensWidth(['.box4 .border-animation'], "390px", 0.2);
                    addTweensWidth(['.box5 .border-animation'], "390px", 0.2);
                    addTweensWidth(['.box6 .border-animation'], "390px", 0.2);
                    addTweensWidth(['.box7 .border-animation'], "390px", 0.2);
    ...
    $("#conversation_form").on("submit", function (e) {
        ...
        var phoneCountry = $("#conversation_phone_country");
        ...
        if (phoneCountry.val().length == 0) {
            isValid = false;
            phoneCountry.tooltip('show');
        }
        ...
        $.post(baseUrl + "/conversation", {
            name: name.val(),
            email: email.val(),
            phone: phoneCountry.val() + "-" + phoneArea.val() + "-" + phoneNumber.val(),
            message: message.val(),
